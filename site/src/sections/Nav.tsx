    ...
    <header className="nav">
      <div className="nav__inner">
        ...
        <div className="nav__end">
          ...
          {auth.configured && (
            <Button className="nav__account" asChild variant="ghost" size="sm">
              <a href={auth.user ? "/account" : "/login"}>{auth.user ? "Account" : "Sign in"}</a>
            </Button>
          )}
            ...
            <Sheet.Content>
              ...
              {auth.configured && (
                <>
                  <Separator />
                  <ul className="nav__sheet">
                    <li><a href={auth.user ? "/account" : "/login"} onClick={() => setOpen(false)}>{auth.user ? "Account" : "Sign in"}</a></li>
                  </ul>
                </>
              )}
            </Sheet.Content>
