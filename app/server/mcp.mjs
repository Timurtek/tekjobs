...
export async function call(name, a = {}) {
  switch (name) {
    ...
    case 'import_linkedin': return linkedin.runImport(a.source, { since: a.since, everyone: !!a.everyone, writePeople: a.writePeople !== false, dry: !!a.dry });
